...
public class RGB_HSV{
    ...
    public static void principal() {
        ...
        double saturation = calcularSaturacao(delta, maior);
        double value = maior;
        
        System.out.println("\nHSV:");
        printHSL(hue, saturation, value);
        
        String dataAtual = Principal.getDateTime();
        
        String cor = "Conversão de RGB para HSV" + " (" + dataAtual + ")"
            + "\nInformado:\t" + "Red: " + CORES.getRed() + "\tGreen: " + CORES.getGreen() + "\tBlue: " + CORES.getBlue()
            + "\nResultado:\t" + "Hue: " + hue + "\tSaturation: " + saturation + "\tValue: " + value + "\n";
    ...
    public static double calcularSaturacao(double delta, double maior){
        double saturacao = 0;
        
        if(delta == 0) saturacao = 0;
        else saturacao = delta / maior;
    ...
    public static void printHSL(double H, double S, double V){
